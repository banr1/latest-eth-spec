...
class Header:
    ...
    [`keccak256`]: ref:ethereum.crypto.hash.keccak256
    [RLP]: https://ethereum.github.io/ethereum-rlp/src/ethereum_rlp/rlp.py.html
    [`EMPTY_OMMER_HASH`]: ref:ethereum.cancun.fork.EMPTY_OMMER_HASH
    """
    ...
    [`keccak256`]: ref:ethereum.crypto.hash.keccak256
    [`state_root()`]: ref:ethereum.cancun.state.state_root
    [Trie]: ref:ethereum.cancun.trie.Trie
    """
    ...
    [`keccak256`]: ref:ethereum.crypto.hash.keccak256
    [`root()`]: ref:ethereum.cancun.trie.root
    [Trie]: ref:ethereum.cancun.trie.Trie
    """
    ...
    [logs bloom]: ref:ethereum.cancun.bloom.logs_bloom
    """
...
class Log:
    ...
    [`LOG0`]: ref:ethereum.cancun.vm.instructions.log.log0
    [`LOG1`]: ref:ethereum.cancun.vm.instructions.log.log1
    [`LOG2`]: ref:ethereum.cancun.vm.instructions.log.log2
    [`LOG3`]: ref:ethereum.cancun.vm.instructions.log.log3
    [`LOG4`]: ref:ethereum.cancun.vm.instructions.log.log4
    """
