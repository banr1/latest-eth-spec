...
class Header:
    ...
    [`keccak256`]: ref:ethereum.crypto.hash.keccak256
    [`state_root()`]: ref:ethereum.constantinople.state.state_root
    [Trie]: ref:ethereum.constantinople.trie.Trie
    """
    ...
    [`keccak256`]: ref:ethereum.crypto.hash.keccak256
    [`root()`]: ref:ethereum.constantinople.trie.root
    [Trie]: ref:ethereum.constantinople.trie.Trie
    """
    ...
    [logs bloom]: ref:ethereum.constantinople.bloom.logs_bloom
    """
    ...
    ref:ethereum.constantinople.fork.calculate_block_difficulty
    """
    ...
    [validates]: ref:ethereum.constantinople.fork.validate_proof_of_work
    """
    ...
    [validate]: ref:ethereum.constantinople.fork.validate_proof_of_work
    """
...
class Block:
    ...
    [`header`]: ref:ethereum.constantinople.blocks.Header
    """
    ...
    [headers]: ref:ethereum.constantinople.blocks.Header
    """
...
class Log:
    ...
    [`LOG0`]: ref:ethereum.constantinople.vm.instructions.log.log0
    [`LOG1`]: ref:ethereum.constantinople.vm.instructions.log.log1
    [`LOG2`]: ref:ethereum.constantinople.vm.instructions.log.log2
    [`LOG3`]: ref:ethereum.constantinople.vm.instructions.log.log3
    [`LOG4`]: ref:ethereum.constantinople.vm.instructions.log.log4
    """
