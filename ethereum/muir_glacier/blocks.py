...
class Header:
    ...
    [`keccak256`]: ref:ethereum.crypto.hash.keccak256
    [`state_root()`]: ref:ethereum.muir_glacier.state.state_root
    [Trie]: ref:ethereum.muir_glacier.trie.Trie
    """
    ...
    [`keccak256`]: ref:ethereum.crypto.hash.keccak256
    [`root()`]: ref:ethereum.muir_glacier.trie.root
    [Trie]: ref:ethereum.muir_glacier.trie.Trie
    """
    ...
    [logs bloom]: ref:ethereum.muir_glacier.bloom.logs_bloom
    """
    ...
    ref:ethereum.muir_glacier.fork.calculate_block_difficulty
    """
    ...
    [validates]: ref:ethereum.muir_glacier.fork.validate_proof_of_work
    """
    ...
    [validate]: ref:ethereum.muir_glacier.fork.validate_proof_of_work
    """
...
class Block:
    ...
    [headers]: ref:ethereum.muir_glacier.blocks.Header
    """
...
class Log:
    ...
    [`LOG0`]: ref:ethereum.muir_glacier.vm.instructions.log.log0
    [`LOG1`]: ref:ethereum.muir_glacier.vm.instructions.log.log1
    [`LOG2`]: ref:ethereum.muir_glacier.vm.instructions.log.log2
    [`LOG3`]: ref:ethereum.muir_glacier.vm.instructions.log.log3
    [`LOG4`]: ref:ethereum.muir_glacier.vm.instructions.log.log4
    """
