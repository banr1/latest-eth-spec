...
class Header:
    ...
    [`keccak256`]: ref:ethereum.crypto.hash.keccak256
    [`state_root()`]: ref:ethereum.byzantium.state.state_root
    [Trie]: ref:ethereum.byzantium.trie.Trie
    """
    ...
    [`keccak256`]: ref:ethereum.crypto.hash.keccak256
    [`root()`]: ref:ethereum.byzantium.trie.root
    [Trie]: ref:ethereum.byzantium.trie.Trie
    """
    ...
    [logs bloom]: ref:ethereum.byzantium.bloom.logs_bloom
    """
    ...
    ref:ethereum.byzantium.fork.calculate_block_difficulty
    """
    ...
    [validates]: ref:ethereum.byzantium.fork.validate_proof_of_work
    """
    ...
    [validate]: ref:ethereum.byzantium.fork.validate_proof_of_work
    """
...
class Block:
    ...
    [headers]: ref:ethereum.byzantium.blocks.Header
    """
...
class Log:
    ...
    [`LOG0`]: ref:ethereum.byzantium.vm.instructions.log.log0
    [`LOG1`]: ref:ethereum.byzantium.vm.instructions.log.log1
    [`LOG2`]: ref:ethereum.byzantium.vm.instructions.log.log2
    [`LOG3`]: ref:ethereum.byzantium.vm.instructions.log.log3
    [`LOG4`]: ref:ethereum.byzantium.vm.instructions.log.log4
    """
