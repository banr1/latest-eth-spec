...
class Header:
    ...
    [`keccak256`]: ref:ethereum.crypto.hash.keccak256
    [RLP]: https://ethereum.github.io/ethereum-rlp/src/ethereum_rlp/rlp.py.html
    [`EMPTY_OMMER_HASH`]: ref:ethereum.paris.fork.EMPTY_OMMER_HASH
    """
    ...
    [`keccak256`]: ref:ethereum.crypto.hash.keccak256
    [`state_root()`]: ref:ethereum.paris.state.state_root
    [Trie]: ref:ethereum.paris.trie.Trie
    """
    ...
    [`keccak256`]: ref:ethereum.crypto.hash.keccak256
    [`root()`]: ref:ethereum.paris.trie.root
    [Trie]: ref:ethereum.paris.trie.Trie
    """
    ...
    [logs bloom]: ref:ethereum.paris.bloom.logs_bloom
    """
...
class Block:
    ...
    a list of transactions, and a list of ommers (deprecated).
