...
class Header:
    ...
    [`keccak256`]: ref:ethereum.crypto.hash.keccak256
    [`state_root()`]: ref:ethereum.homestead.state.state_root
    [Trie]: ref:ethereum.homestead.trie.Trie
    """
    ...
    [`keccak256`]: ref:ethereum.crypto.hash.keccak256
    [`root()`]: ref:ethereum.homestead.trie.root
    [Trie]: ref:ethereum.homestead.trie.Trie
    """
    ...
    [logs bloom]: ref:ethereum.homestead.bloom.logs_bloom
    """
    ...
    ref:ethereum.homestead.fork.calculate_block_difficulty
    """
    ...
    [validates]: ref:ethereum.homestead.fork.validate_proof_of_work
    """
    ...
    [validate]: ref:ethereum.homestead.fork.validate_proof_of_work
    """
...
class Block:
    ...
    [`header`]: ref:ethereum.homestead.blocks.Header
    """
    ...
    [headers]: ref:ethereum.homestead.blocks.Header
    """
...
class Log:
    ...
    [`LOG0`]: ref:ethereum.homestead.vm.instructions.log.log0
    [`LOG1`]: ref:ethereum.homestead.vm.instructions.log.log1
    [`LOG2`]: ref:ethereum.homestead.vm.instructions.log.log2
    [`LOG3`]: ref:ethereum.homestead.vm.instructions.log.log3
    [`LOG4`]: ref:ethereum.homestead.vm.instructions.log.log4
    """
