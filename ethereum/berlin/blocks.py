...
class Header:
    ...
    [Trie]: ref:ethereum.berlin.trie.Trie
    """
    ...
    [logs bloom]: ref:ethereum.berlin.bloom.logs_bloom
    """
    ...
    [validate]: ref:ethereum.berlin.fork.validate_proof_of_work
    """
...
class Log:
    ...
    [`LOG2`]: ref:ethereum.berlin.vm.instructions.log.log2
    [`LOG3`]: ref:ethereum.berlin.vm.instructions.log.log3
    [`LOG4`]: ref:ethereum.berlin.vm.instructions.log.log4
    """
