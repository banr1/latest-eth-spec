...
class Withdrawal:
    ...
    [`block`]: ref:ethereum.shanghai.blocks.Block.withdrawals
    """
...
class Header:
    ...
    [`keccak256`]: ref:ethereum.crypto.hash.keccak256
    [`state_root()`]: ref:ethereum.shanghai.state.state_root
    [Trie]: ref:ethereum.shanghai.trie.Trie
    """
    ...
    [logs bloom]: ref:ethereum.shanghai.bloom.logs_bloom
    """
