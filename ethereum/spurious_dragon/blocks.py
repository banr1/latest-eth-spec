...
class Header:
    ...
    [`keccak256`]: ref:ethereum.crypto.hash.keccak256
    [`state_root()`]: ref:ethereum.spurious_dragon.state.state_root
    [Trie]: ref:ethereum.spurious_dragon.trie.Trie
    """
    ...
    [`keccak256`]: ref:ethereum.crypto.hash.keccak256
    [`root()`]: ref:ethereum.spurious_dragon.trie.root
    [Trie]: ref:ethereum.spurious_dragon.trie.Trie
    """
    ...
    [logs bloom]: ref:ethereum.spurious_dragon.bloom.logs_bloom
    """
    ...
    ref:ethereum.spurious_dragon.fork.calculate_block_difficulty
    """
    ...
    [validates]: ref:ethereum.spurious_dragon.fork.validate_proof_of_work
    """
    ...
    [validate]: ref:ethereum.spurious_dragon.fork.validate_proof_of_work
    """
...
class Block:
    ...
    [`header`]: ref:ethereum.spurious_dragon.blocks.Header
    """
    ...
    [headers]: ref:ethereum.spurious_dragon.blocks.Header
    """
...
class Log:
    ...
    [`LOG0`]: ref:ethereum.spurious_dragon.vm.instructions.log.log0
    [`LOG1`]: ref:ethereum.spurious_dragon.vm.instructions.log.log1
    [`LOG2`]: ref:ethereum.spurious_dragon.vm.instructions.log.log2
    [`LOG3`]: ref:ethereum.spurious_dragon.vm.instructions.log.log3
    [`LOG4`]: ref:ethereum.spurious_dragon.vm.instructions.log.log4
    """
