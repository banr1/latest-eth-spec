...
class Header:
    ...
    ref:ethereum.istanbul.fork.calculate_block_difficulty
    """
...
class Block:
    ...
    [headers]: ref:ethereum.istanbul.blocks.Header
    """
...
class Log:
    ...
    [`LOG0`]: ref:ethereum.istanbul.vm.instructions.log.log0
    [`LOG1`]: ref:ethereum.istanbul.vm.instructions.log.log1
    [`LOG2`]: ref:ethereum.istanbul.vm.instructions.log.log2
    [`LOG3`]: ref:ethereum.istanbul.vm.instructions.log.log3
    [`LOG4`]: ref:ethereum.istanbul.vm.instructions.log.log4
    """
