...
class Header:
    ...
    [`keccak256`]: ref:ethereum.crypto.hash.keccak256
    [`state_root()`]: ref:ethereum.tangerine_whistle.state.state_root
    [Trie]: ref:ethereum.tangerine_whistle.trie.Trie
    """
    ...
    [`keccak256`]: ref:ethereum.crypto.hash.keccak256
    [`root()`]: ref:ethereum.tangerine_whistle.trie.root
    [Trie]: ref:ethereum.tangerine_whistle.trie.Trie
    """
    ...
    [logs bloom]: ref:ethereum.tangerine_whistle.bloom.logs_bloom
    """
    ...
    ref:ethereum.tangerine_whistle.fork.calculate_block_difficulty
    """
    ...
    [validates]: ref:ethereum.tangerine_whistle.fork.validate_proof_of_work
    """
    ...
    [validate]: ref:ethereum.tangerine_whistle.fork.validate_proof_of_work
    """
...
class Block:
    ...
    [`header`]: ref:ethereum.tangerine_whistle.blocks.Header
    """
    ...
    [headers]: ref:ethereum.tangerine_whistle.blocks.Header
    """
...
class Log:
    ...
    [`LOG0`]: ref:ethereum.tangerine_whistle.vm.instructions.log.log0
    [`LOG1`]: ref:ethereum.tangerine_whistle.vm.instructions.log.log1
    [`LOG2`]: ref:ethereum.tangerine_whistle.vm.instructions.log.log2
    [`LOG3`]: ref:ethereum.tangerine_whistle.vm.instructions.log.log3
    [`LOG4`]: ref:ethereum.tangerine_whistle.vm.instructions.log.log4
    """
